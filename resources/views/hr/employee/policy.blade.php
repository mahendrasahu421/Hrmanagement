		...
		<div class="modal fade" id="add_policy">
			<div class="modal-dialog modal-dialog-centered modal-lg">
				<div class="modal-content">
					...
					<form action="https://smarthr.co.in/demo/html/template/policy.html">
									...
									<div class="mb-3">
										...
										<div class="policy-upload d-flex flex-column align-items-center">
											<div class="policy-upload-bg mb-2 rounded-circle d-flex align-items-center justify-content-center bg-primary-transparent">
												<span><img src="https://smarthr.co.in/demo/html/template/assets/img/folder-open.svg" alt="Img" class="img-fluid"></span>
											</div>
				...
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="https://smarthr.co.in/demo/html/template/policy.html" class="btn btn-danger">Yes, Delete</a>
						</div>
					</div>
				</div>
			</div>
