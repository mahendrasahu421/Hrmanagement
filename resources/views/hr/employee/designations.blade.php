		...
		<div class="modal fade" id="add_designation">
			<div class="modal-dialog modal-dialog-centered modal-md">
				<div class="modal-content">
					...
					<form action="https://smarthr.co.in/demo/html/template/designations.html">
				...
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="https://smarthr.co.in/demo/html/template/designations.html" class="btn btn-danger">Yes, Delete</a>
						</div>
					</div>
				</div>
			</div>
