			...
			<div class="content">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
					<div class="my-auto mb-2">
						<h6 class="fw-medium d-inline-flex align-items-center mb-3 mb-sm-0"><a href="{{ route('hr.employee.index') }}">
						...
						<div class="card card-bg-1">
							<div class="card-body p-0">
								<span class="avatar avatar-xl avatar-rounded border border-2 border-white m-auto d-flex mb-2">
									<img src="https://smarthr.co.in/demo/html/template/assets/img/users/user-13.jpg" class="w-auto h-auto" alt="Img">
								</span>
								...
								<div class="p-3 border-bottom">
									...
									<div class="d-flex align-items-center justify-content-between mb-2">
										...
										<a href="javascript:void(0);" class="text-info d-inline-flex align-items-center"><span class="__cf_email__" data-cfemail="e292879090838e96d3d0a2879a838f928e87cc818d8f">[email&#160;protected]</span><i class="ti ti-copy text-dark ms-2"></i></a>
									</div>
									<div class="d-flex align-items-center justify-content-between mb-2">
										<span class="d-inline-flex align-items-center">
											...
											<div class="col-md-12">
												<div class="d-flex align-items-center flex-wrap row-gap-3 bg-light w-100 rounded p-3 mb-4">                                                
													<div class="d-flex align-items-center justify-content-center avatar avatar-xxl rounded-circle border border-dashed me-2 flex-shrink-0 text-dark frames">
														<img src="https://smarthr.co.in/demo/html/template/assets/img/users/user-13.jpg" alt="img" class="rounded-circle">
													</div>                                              
					...
					<div class="modal-body">
						<div class="bg-light p-3 rounded d-flex align-items-center mb-3">
							<span class="avatar avatar-lg flex-shrink-0 me-2">
								<img src="https://smarthr.co.in/demo/html/template/assets/img/laptop.jpg" alt="img" class="ig-fluid rounded-circle">
							</span>
							<div>
						...
						<div>
							...
							<div class="d-flex align-items-center">
								<img src="https://smarthr.co.in/demo/html/template/assets/img/laptop-01.jpg" alt="img" class="img-fluid rounded me-2">
								<img src="https://smarthr.co.in/demo/html/template/assets/img/laptop-2.jpg" alt="img" class="img-fluid rounded me-2">
								<img src="https://smarthr.co.in/demo/html/template/assets/img/laptop-3.jpg" alt="img" class="img-fluid rounded">
							</div>
						</div> 
					</div>
				</div>
