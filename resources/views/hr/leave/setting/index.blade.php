								...
								<div class="col-md-12">
									<div class="mb-3">
                                        ...
                                        <select class="select-img">
                                            ...
                                            <option data-image="https://smarthr.co.in/demo/html/template/assets/img/users/user-58.jpg">Cameron</option>
                                            <option data-image="https://smarthr.co.in/demo/html/template/assets/img/users/user-42.jpg">Doris</option>
                                            <option data-image="https://smarthr.co.in/demo/html/template/assets/img/users/user-10.jpg">Rufana</option>
                                            <option data-image="https://smarthr.co.in/demo/html/template/assets/img/users/user-39.jpg">Michael</option>
                                        </select>
									</div>
								</div>
							</div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between mb-3">									
                                                        ...
                                                        <div class="avatar-list-stacked avatar-group-sm">
                                                            <span class="avatar border-0">
                                                                <img src="https://smarthr.co.in/demo/html/template/assets/img/users/user-09.jpg" class="rounded-circle" alt="img">
                                                            </span>
                                                            <span class="avatar border-0">
                                                                <img src="https://smarthr.co.in/demo/html/template/assets/img/users/user-13.jpg" class="rounded-circle" alt="img">
                                                            </span>
                                                            <span class="avatar border-0">
                                                                <img src="https://smarthr.co.in/demo/html/template/assets/img/users/user-11.jpg" class="rounded-circle" alt="img">
                                                            </span>
                                                            <span class="avatar border-0">
                                                                <img src="https://smarthr.co.in/demo/html/template/assets/img/users/user-32.jpg" class="rounded-circle" alt="img">
                                                            </span>
                                                            <span class="avatar border-0">
                                                                <img src="https://smarthr.co.in/demo/html/template/assets/img/users/user-58.jpg" class="rounded-circle" alt="img">
                                                            </span>
