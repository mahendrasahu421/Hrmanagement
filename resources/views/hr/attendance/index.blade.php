					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
						<div class="me-2 mb-2">
							<div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
								<a href="https://smarthr.co.in/demo/html/template/attendance-employee.html" class="btn btn-icon btn-sm  me-1"><i
										class="ti ti-brand-days-counter"></i></a>
								<a href="https://smarthr.co.in/demo/html/template/attendance-admin.html" class="btn btn-icon btn-sm active bg-primary text-white"><i
								...
								<div class="d-flex align-items-center justify-content-md-end">
									...
									<div class="avatar-list-stacked avatar-group-sm ms-4">
										<span class="avatar avatar-rounded">
											<img class="border border-white" src="https://smarthr.co.in/demo/html/template/assets/img/profiles/avatar-02.jpg"
												alt="img">
										</span>
										<span class="avatar avatar-rounded">
											<img class="border border-white" src="https://smarthr.co.in/demo/html/template/assets/img/profiles/avatar-03.jpg"
												alt="img">
										</span>
										<span class="avatar avatar-rounded">
											<img class="border border-white" src="https://smarthr.co.in/demo/html/template/assets/img/profiles/avatar-05.jpg"
												alt="img">
										</span>
										<span class="avatar avatar-rounded">
											<img class="border border-white" src="https://smarthr.co.in/demo/html/template/assets/img/profiles/avatar-06.jpg"
												alt="img">
										</span>
										<span class="avatar avatar-rounded">
											<img class="border border-white" src="https://smarthr.co.in/demo/html/template/assets/img/profiles/avatar-07.jpg"
												alt="img">
										</span>
								...
								<tbody>
										...
										<td>
											<div class="d-flex align-items-center file-name-icon">
												<a href="#" class="avatar avatar-md border avatar-rounded">
													<img src="https://smarthr.co.in/demo/html/template/assets/img/users/user-49.jpg" class="img-fluid" alt="img">
												</a>
												<div class="ms-2">
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center file-name-icon">
												<a href="#" class="avatar avatar-md border avatar-rounded">
													<img src="https://smarthr.co.in/demo/html/template/assets/img/users/user-30.jpg" class="img-fluid" alt="img">
												</a>
												<div class="ms-2">
		...
		<div class="modal fade" id="edit_attendance">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<form action="https://smarthr.co.in/demo/html/template/attendance-admin.html">
									...
									<div class="col-lg-4">
										<div class="d-flex align-items-center mb-3">
											<span class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
												<img src="https://smarthr.co.in/demo/html/template/assets/img/profiles/avatar-02.jpg" alt="Img">
											</span>
											<div>
