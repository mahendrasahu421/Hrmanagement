                        ...
                        <li>
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li class="submenu submenu-two">
                                            ...
                                            <ul>
                                                <li><a href="{{ route('hr.leave.index') }}" class="active">Leaves
                                                        (Admin)</a></li>
                                                <li><a href="{{ route('hr.leave.setting.index') }}">Leave Settings</a>
                                                </li>
                                            </ul>
                                        </li>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li><a href="{{ route('hr.performance-indicator.index') }}">Performance
                                                Indicator</a></li>
                                        <li><a href="{{ route('hr.performance-review.index') }}">Performance
                                                Review</a></li>
                                        <li><a href="{{ route('hr.performance-appraisal.index') }}">Performance
                                                Appraisal</a></li>
                                        <li><a href="{{ route('hr.goal-tracking.index') }}">Goal List</a></li>
                                        <li><a href="{{ route('hr.goal-type.goal-type') }}">Goal Type</a></li>
                                    </ul>
                                </li>
                                <li class="submenu">
                                    <a href="javascript:void(0);">
                                    ...
                                    <ul>
                                        <li><a href="{{ route('hr.training.index') }}">Training List</a></li>
                                        <li><a href="{{ route('hr.trainers.index') }}">Trainers</a></li>
                                        <li><a href="{{ route('hr.training-type.index') }}">Training Type</a></li>
                                    </ul>
                                </li>
                                <li>
