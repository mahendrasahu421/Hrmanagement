        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                            ...
                            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                                <div class="mb-2">
                                    <a href="{{ route('masters.organisation.department') }}" class="btn btn-primary d-flex align-items-center">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('masters.organisation.department.update', $department->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-control" id="company_id" name="company_id" required>
                                        ...
                                        <option value="1" {{ $department->company_id == 1 ? 'selected' : '' }}>Nerual Info Solution Pvt Ltd</option>
                                    </select>
                                    @error('company_id')
