                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="leave_name" name="leave_name"
                                            value="{{ old('leave_name') }}" placeholder="Enter Leave Type Name" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="leave_code" name="leave_code"
                                            value="{{ old('leave_code') }}" placeholder="Enter Leave Code" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="total_leaves" name="total_leaves"
                                            value="{{ old('total_leaves', 0) }}" placeholder="Enter Total Leaves" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control" id="applicable_for" name="applicable_for" required>
                                            ...
                                            <option value="Male" {{ old('applicable_for') == 'Male' ? 'selected' : '' }}>
                                                Male</option>
                                            <option value="Female"
                                                {{ old('applicable_for') == 'Female' ? 'selected' : '' }}>Female</option>
                                            <option value="All" {{ old('applicable_for') == 'All' ? 'selected' : '' }}>
                                                All</option>
                                        </select>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control" id="leave_category" name="leave_category" required>
                                            ...
                                            <option value="Paid" {{ old('leave_category') == 'Paid' ? 'selected' : '' }}>
                                                Paid</option>
                                            <option value="Unpaid"
                                                {{ old('leave_category') == 'Unpaid' ? 'selected' : '' }}>Unpaid</option>
                                            <option value="Special"
                                                {{ old('leave_category') == 'Special' ? 'selected' : '' }}>Special</option>
                                        </select>
