                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Quality</td>
                                        <td><input type="text" class="form-control" readonly="" value="30">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>PMS,New Ideas</td>
                                        <td><input type="text" class="form-control" readonly="" value="10">
                                        </td>
                                        <td><input type="text" class="form-control"></td>
                                        <td><input type="text" class="form-control" readonly="" value="0">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" readonly="" value="5">
                                        </td>
                                        <td><input type="text" class="form-control"></td>
                                        <td><input type="text" class="form-control" readonly="" value="0">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" readonly="" value="85">
                                        </td>
                                        <td><input type="text" class="form-control" readonly="" value="0">
                                        </td>
                                        <td><input type="text" class="form-control" readonly="" value="0">
                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" readonly="" value="2">
                                        </td>
                                        <td><input type="text" class="form-control"></td>
                                        <td><input type="text" class="form-control" readonly="" value="0">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" readonly="" value="3">
                                        </td>
                                        <td><input type="text" class="form-control"></td>
                                        <td><input type="text" class="form-control" readonly="" value="0">
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center">Total </td>
                                        <td><input type="text" class="form-control" readonly="" value="15">
                                        </td>
                                        <td><input type="text" class="form-control" readonly="" value="0">
                                        </td>
                                        <td><input type="text" class="form-control" readonly="" value="0">
                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-1-b6t6" tabindex="-1" aria-hidden="true">
                                                <option data-select2-id="select2-data-3-3sv4">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-2-30xf"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-5z0i-container"
                                                        aria-controls="select2-5z0i-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-5z0i-container" role="textbox"
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-4-8rfh" tabindex="-1" aria-hidden="true">
                                                <option data-select2-id="select2-data-6-xta0">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-5-jaci"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-iwy7-container"
                                                        aria-controls="select2-iwy7-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-iwy7-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-7-fdi1" tabindex="-1" aria-hidden="true">
                                                <option data-select2-id="select2-data-9-r64x">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-8-9amw"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-52zo-container"
                                                        aria-controls="select2-52zo-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-52zo-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-10-bdjk" tabindex="-1" aria-hidden="true">
                                                <option data-select2-id="select2-data-12-a9ut">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-11-mv39"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-08pn-container"
                                                        aria-controls="select2-08pn-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-08pn-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-13-paj8" tabindex="-1" aria-hidden="true">
                                                <option data-select2-id="select2-data-15-pz48">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-14-ei0e"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-dmem-container"
                                                        aria-controls="select2-dmem-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-dmem-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-16-fzim" tabindex="-1" aria-hidden="true">
                                                <option data-select2-id="select2-data-18-1o3o">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-17-y73n"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-iyti-container"
                                                        aria-controls="select2-iyti-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-iyti-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-19-bk1z" tabindex="-1" aria-hidden="true">
                                                <option data-select2-id="select2-data-21-lm62">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-20-m7tn"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-4vn7-container"
                                                        aria-controls="select2-4vn7-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-4vn7-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-22-4f7e" tabindex="-1" aria-hidden="true">
                                                <option data-select2-id="select2-data-24-n9ru">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-23-g0wi"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-kmh1-container"
                                                        aria-controls="select2-kmh1-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-kmh1-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-25-kc22" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-27-225a">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-26-2j26"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-756q-container"
                                                        aria-controls="select2-756q-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-756q-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-28-ynna" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-30-zya3">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-29-9ct1"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-zdp6-container"
                                                        aria-controls="select2-zdp6-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-zdp6-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-31-zhf7" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-33-9p65">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-32-51rl"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-kimv-container"
                                                        aria-controls="select2-kimv-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-kimv-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-34-c7zs" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-36-u2sj">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-35-04kq"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-5hsr-container"
                                                        aria-controls="select2-5hsr-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-5hsr-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-37-qrga" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-39-b5jl">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-38-qoz7"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-ogk9-container"
                                                        aria-controls="select2-ogk9-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-ogk9-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select select2-hidden-accessible"
                                                data-select2-id="select2-data-40-27mi" tabindex="-1"
                                                aria-hidden="true">
                                                <option data-select2-id="select2-data-42-y5mr">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select><span class="select2 select2-container select2-container--default"
                                                dir="ltr" data-select2-id="select2-data-41-05w3"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-c1e7-container"
                                                        aria-controls="select2-c1e7-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-c1e7-container" role="textbox"
                                                            aria-readonly="true" title="Select">Select</span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
